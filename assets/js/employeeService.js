...
function createEmployee(data) {
  ...
  const employee = {
    ...
    weeklyWorkDays:  data.weeklyWorkDays  != null && data.weeklyWorkDays  !== '' ? Number(data.weeklyWorkDays)  : 5,
    weeklyWorkHours: data.weeklyWorkHours != null && data.weeklyWorkHours !== '' ? Number(data.weeklyWorkHours) : 40,
    annualWorkDays:  data.annualWorkDays  != null && data.annualWorkDays  !== '' ? Number(data.annualWorkDays)  : 260,
    note: data.note || '',
    createdAt: now,
    updatedAt: now,
  };
...
function updateEmployee(id, data) {
  ...
  const updated = {
    ...
    workType:       data.workType       !== undefined ? (data.workType || 'normal') : (employees[idx].workType || 'normal'),
    weeklyWorkDays:  data.weeklyWorkDays  != null && data.weeklyWorkDays  !== '' ? Number(data.weeklyWorkDays)  : (employees[idx].weeklyWorkDays  ?? 5),
    weeklyWorkHours: data.weeklyWorkHours != null && data.weeklyWorkHours !== '' ? Number(data.weeklyWorkHours) : (employees[idx].weeklyWorkHours ?? 40),
    annualWorkDays:  data.annualWorkDays  != null && data.annualWorkDays  !== '' ? Number(data.annualWorkDays)  : (employees[idx].annualWorkDays  ?? 260),
